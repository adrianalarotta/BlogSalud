...
<head>
  ...
  <title>Barra de Navegación Azul con Bootstrap</title>
  <!-- Enlace a los estilos de Bootstrap -->
  <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
  <style>
    /* Cambiar el color de fondo de la barra de navegación */
    .navbar-custom {
      background-color: #87b1de; /* Cambia el color a azul */
    }

    .navbar-nav {
      margin-left: auto; /* Empujar las opciones hacia la derecha */
    }
  </style>
</head>
<body>
