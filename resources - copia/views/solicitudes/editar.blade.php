        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <form action="{{ route('actualizar_registro', ['id' => $user->id]) }}" method="POST"> 
                            @csrf

                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="tipo_documento" value="{{ $user->tipo_documento }}">{{ __('Tipo de Documento') }}</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="nombres" type="text" class="form-control" name="nombres" value="{{ $user->nombres }}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="apellidos" type="text" class="form-control" name="apellidos" value="{{ $user->apellidos}}" required>
                                    </div>
                                </div>

                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="estado" value="{{ $user->estado}}">{{ __('Estado') }}</label>
                            ...
                            <textarea id="observacion" class="form-control" name="observacion" value="{{ $user->observacion }}"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="telefonos" type="text" class="form-control" name="telefonos" value="{{ $user->telefonos }}">
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="genero" value="{{ $user->genero }}">{{ __('Género') }} </label>
